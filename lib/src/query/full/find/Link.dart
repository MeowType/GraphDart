...
class Link<F> {
  ...
  LinkNode<F, T> node<T>([Func1<bool, T> where]) => LinkNode(this, where, null);

  Iterable<FindLinkBox<F, dynamic>> get end => _parent._parent._parent.find_all_link(fromWhere: _parent._where, fromSpace: _parent._space, linkSpace: _space, direct: LinkDirection.To);
  Iterable<FindLinkBox<F, dynamic>> get mutual => _parent._parent._parent.find_all_link(fromWhere: _parent._where, fromSpace: _parent._space, linkSpace: _space, direct: LinkDirection.Mutual);
}
...
class LinkNode<F, T> {
  ...
  Iterable<FindLinkBox<F, T>> get end => _parent._parent._parent._parent
      .find_all_link(fromWhere: _parent._parent._where, fromSpace: _parent._parent._space, toWhere: _where, toSpace: _space, linkSpace: _parent._space, direct: LinkDirection.Mutual);
}
