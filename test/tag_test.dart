...
void main() {
  group('tags', () {
    ...
    test('setTo get', () {
      ...
      expect(g.tryGet(from, to, key, anyTags: [t2, t3]) is Some, isTrue);

      expect(g.tryGet(from, to, key, allTags: [t1]).has, isTrue);
      expect(g.tryGet(from, to, key, allTags: [t1, t2]).has, isTrue);
